...
export default function AboutUs() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-green-900/40 to-black/70"></div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6 pt-6">
              ...
              <div className="text-center p-4 bg-emerald-50 rounded-xl">
                ...
                <div className="text-gray-700 font-medium">Online Booking</div>
              </div>
            </div>
          </div>
                ...
                <CardBody className="p-6">
                  ...
                  <ul className="space-y-3 text-gray-700">
                    <li className="flex items-start gap-3">
                      ...
                      <div>
                        <strong>Football boots:</strong> Specialized shoes with
                        studs or cleats for traction on grass or turf surfaces.
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-green-600 rounded-full mt-2 flex-shrink-0"></div>
                      <div>
                        <strong>Football:</strong> Standard size 5 ball
                        (circumference: 68-70cm) for official matches, or
                        smaller sizes for training.
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-green-600 rounded-full mt-2 flex-shrink-0"></div>
                      <div>
                        <strong>Shin guards:</strong> Protective equipment worn
                        under socks to protect the shins during play.
                      </div>
                    </li>
                    <li className="flex items-start gap-3">
                      <div className="w-2 h-2 bg-green-600 rounded-full mt-2 flex-shrink-0"></div>
                      <div>
                        <strong>Jersey & shorts:</strong> Comfortable athletic
                        wear, preferably moisture-wicking fabric.
                      </div>
                    </li>
                  </ul>
                </CardBody>
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-green-600 via-green-700 to-emerald-800 py-16">
